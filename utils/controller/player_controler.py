...
def render_player(player):
    ...
    view.add_item(Button(style=ButtonStyle.success, emoji="⏮️", disabled=True if player.queue.next_track.__len__ == 0 else False, custom_id="player_controller_prev_track_btn"))
